...
ActiveRecord::Schema.define(version: 2021_10_28_205339) do
  ...
  create_table "vaccination_lists", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.date "date"
    ...
    t.index ["vaccine_id"], name: "index_vaccination_lists_on_vaccine_id"
  end
  ...
  add_foreign_key "vaccination_lists", "babies"
  add_foreign_key "vaccination_lists", "vaccines"
end
